...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id', 'lfdnr', 'stay_arrival_date', 'stay_departure_date', 'stay_num_of_guests',
        ...
        'id_number', 'id_issue_date', 'id_institution', 'id_country', 'signature_date', 'abnb_id', 'abnb_name', 'email', 'marketing_consent', 'for_business',
    )
